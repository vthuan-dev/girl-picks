...
export default function GirlBookingsPage() {
  ...
  return (
    <div className="space-y-6">
      {/* Header */}
      <div>
        <h1 className="text-2xl sm:text-3xl font-bold text-text mb-2">Đặt lịch</h1>
      ...
      <div className="space-y-4">
        {filteredBookings.length === 0 ? (
          ...
          filteredBookings.map((booking) => (
            <BookingCard key={booking.id} booking={booking} view="girl" />
          ))
        )}
      </div>
    </div>
