...
export default function GirlSidebar() {
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="p-6 border-b border-secondary/30">
            <Link href="/dashboard" className="flex items-center gap-3">
              ...
              <div>
                <h1 className="font-bold text-text">Girl Dashboard</h1>
                <p className="text-xs text-text-muted">Quản lý của bạn</p>
              </div>
            </Link>
          </div>
