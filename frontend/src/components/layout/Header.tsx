            ...
            <div className="flex items-center gap-1 sm:gap-1.5 md:gap-2 lg:gap-3 flex-shrink-0">
              ...
              {isAuthenticated ? (
                <div className="relative" ref={userMenuRef}>
                  ...
                  {isUserMenuOpen && (
                    <div
                      className="absolute right-0 mt-2 w-60 bg-gradient-to-br from-background-light/95 via-background/95 to-background-light/90 rounded-2xl border border-secondary/30 shadow-2xl shadow-black/30 overflow-hidden animate-fadeIn z-50 backdrop-blur"
                      role="menu"
                      aria-orientation="vertical"
                    >
                      <div className="p-4 border-b border-secondary/20 bg-background/60">
                      ...
                      <div className="py-2">
                        ...
                        >
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <p className="text-xs text-text-muted">Về trang điều khiển</p>
                          </div>
                        </Link>
                        <Link
                          href="/profile"
                        ...
                        >
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <p className="text-xs text-text-muted">Xem / chỉnh sửa hồ sơ</p>
                          </div>
                        </Link>
                        <div className="border-t border-secondary/20 my-2" role="separator" />
                        <button
                        ...
                        >
                          ...
                          <div className="flex-1 min-w-0">
                            <p className="font-medium text-red-400">Đăng xuất</p>
                            <p className="text-xs text-text-muted">Thoát tài khoản</p>
                          </div>
                        </button>
                      </div>
                    </div>
