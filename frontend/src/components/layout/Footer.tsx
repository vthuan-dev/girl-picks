      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-8 py-8 sm:py-12">
        <div className="space-y-8">
          <div className="grid grid-cols-3 sm:grid-cols-3 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
            <div>
              <h3 className="text-text font-semibold mb-3 text-sm sm:text-base">Liên kết nhanh</h3>
            ...
            <div>
              <h3 className="text-text font-semibold mb-3 text-sm sm:text-base">Thông tin</h3>
              <ul className="space-y-2">
                <li>
            ...
            <div>
              <h3 className="text-text font-semibold mb-3 text-sm sm:text-base">Hỗ trợ</h3>
              <ul className="space-y-2">
                <li>
        ...
        <div className="mt-8 pt-6 border-t border-secondary/30 flex flex-col">
