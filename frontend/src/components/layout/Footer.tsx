        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 mb-8">
          ...
          <div className="col-span-1 sm:col-span-2 lg:col-span-1">
            ...
            <div className="flex items-center gap-2">
              <a 
                href="https://satgai.net" 
                target="_blank" 
                rel="noopener noreferrer"
                className="w-9 h-9 bg-background rounded-lg flex items-center justify-center hover:bg-primary hover:text-white transition-all group cursor-pointer border border-secondary/30"
                aria-label="Mạng xã hội"
              >
                <svg className="w-4 h-4 text-text-muted group-hover:text-white transition-colors" fill="currentColor" viewBox="0 0 24 24">
