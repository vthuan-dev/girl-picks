        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-10 lg:gap-12 mb-10">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            <Link href="/" className="flex items-center gap-3 mb-4 group cursor-pointer">
              <div className="relative w-12 h-12 rounded-xl overflow-hidden bg-background-light shadow-lg group-hover:shadow-primary/30 transition-all flex-shrink-0">
                <Image
            ...
            <div className="flex items-center gap-3 mb-4">
              <a
                ...
                className="w-10 h-10 bg-background rounded-lg flex items-center justify-center hover:bg-primary hover:text-white transition-all group cursor-pointer border border-secondary/30"
                aria-label="Facebook"
              >
          ...
          {/* Liên kết nhanh */}
          <div>
            <h3 className="text-text font-semibold mb-4 text-base">Liên kết nhanh</h3>
            <ul className="space-y-2.5">
              <li>
                <Link href="/" className="text-text-muted hover:text-primary transition-colors text-sm flex items-center gap-2 group cursor-pointer">
                  <span className="w-1.5 h-1.5 bg-text-muted rounded-full group-hover:bg-primary transition-colors flex-shrink-0"></span>
                  <span>Trang chủ</span>
                </Link>
              </li>
              <li>
          ...
          {/* Thông tin */}
          <div>
            <h3 className="text-text font-semibold mb-4 text-base">Thông tin</h3>
            <ul className="space-y-2.5">
              <li>
          ...
          {/* Hỗ trợ */}
          <div>
            <h3 className="text-text font-semibold mb-4 text-base">Hỗ trợ</h3>
            <ul className="space-y-2.5">
              <li>
